...
public class ViewPainted extends View{
    ...
    public ViewPainted(Context context) {
        this(context, null);
    }

    public ViewPainted(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void clear() {
        Log.v("zyxyz", "ClearMethod");
        backgroundColor = DEFAULT_BG_COLOR;
        Log.v("zyxyz", String.valueOf(backgroundColor));
        paths.clear();
        normal();
        invalidate();
    }
